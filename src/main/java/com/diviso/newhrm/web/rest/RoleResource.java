...
public class RoleResource {
    ...
    /**
     * This method is used to findRoleByPeopleId
     * 
     * @param id
     * @return  id
     */
    @GetMapping(value = "/role/findRoleByPeopleId/{id}")
	@Timed
	public ResponseEntity<Page<RoleDTO>> findRoleByPeopleId(@PathVariable long id,Pageable pageable) {
    	log.debug("REST request to findRoleByPeopleId peopleId : {}", id,pageable);
    	Page<RoleDTO> roleDTO  = roleService.getRoleByPeopleId(id,pageable);
		return ResponseUtil.wrapOrNotFound(Optional.ofNullable(roleDTO)); 
	}
}
